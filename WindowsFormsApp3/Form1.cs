    ...
    public partial class Form1 : Form {
        ...
        public Form1() {
            ...
            scoreLabel = new Label {
                Location = new Point((mapWidth) * 20 + 1, 50),
                Text = "Score: " + score
            };
        ...
        public void Init() {
            Width = (mapWidth + 5) * 20;
            Height = (mapHeight + 2) * 20;
            arcanoidSet = new Bitmap("D:\\UwB\\Grafika\\lab_2\\WindowsFormsApp3\\WindowsFormsApp3\\image\\arcanoid.png");
            timer1.Interval = 80;
